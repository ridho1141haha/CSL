  ...
  return (
    <div className="menu" ref={ref}>
      <div className="menu-top">
        ...
        <span className="chip">BUILD 0.15.0 <i>//</i> TEAM CHAOS</span>
      ...
      <div className="menu-version">BUILD 0.15.0 <span className="menu-input-note">KEYBOARD + MOUSE / SENTUH</span> <span>CHAOS SCHOOL LIFE © 2025</span></div>
