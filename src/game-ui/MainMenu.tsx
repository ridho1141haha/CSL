  ...
  return (
    <div className="menu" ref={ref}>
      <div className="menu-top">
        ...
        <span className="chip">BUILD 0.4.0 <i>//</i> TEAM CHAOS</span>
      ...
      <div className="menu-version">BUILD 0.4.0 <span>KEYBOARD + MOUSE · DESKTOP</span> <span>CHAOS SCHOOL LIFE © 2025</span></div>
    </div>
  );
}
